    ...
    <main>
      ...
      <div class="overflow-hidden rounded-xl border border-brand-border">
        <table class="w-full text-sm">
          <thead class="bg-brand-bg-subtle text-left text-xs uppercase text-brand-text-secondary"><tr><th class="px-4 py-3">Assinante</th><th class="px-4 py-3">Plano</th><th class="px-4 py-3">Criada em</th><th class="px-4 py-3">Status</th></tr></thead>
