...
$staticPages = ['', 'imoveis.php', 'imobiliarias.php', 'como-anunciar.php', 'quem-somos.php', 'fale-conosco.php', 'planos.php', 'blog.php', 'guias.php', 'comparar.php', 'termos-de-uso.php', 'politica-de-privacidade.php', 'login.php', 'cadastro.php'];
...
$posts = $pdo->query('SELECT slug FROM articles WHERE kind = "BLOG"')->fetchAll(PDO::FETCH_COLUMN);
...
foreach ($posts as $slug) {
    sitemap_url("$appUrl/blog-post.php?slug=$slug", '0.4');
}
