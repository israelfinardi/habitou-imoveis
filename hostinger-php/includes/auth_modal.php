          ...
          <form id="authm-form" method="post" enctype="multipart/form-data" novalidate>
            ...
            <section class="authm-step" data-step="entry">
              ...
              <?php if (oauth_configured('google') || oauth_configured('facebook')): ?>
                <div class="my-5 flex items-center gap-3 text-xs text-brand-text-secondary">
                ...
                <div class="flex flex-col gap-2.5">
                  <?php if (oauth_configured('google')): ?>
                    <a href="<?= e(base_url('actions/oauth_start.php?provider=google')) ?>" id="authm-oauth-google" class="authm-oauth-link flex items-center justify-center gap-2 rounded-xl border border-brand-border py-3 text-sm font-semibold hover:bg-brand-bg-subtle">
                  ...
                  <?php if (oauth_configured('facebook')): ?>
                    <a href="<?= e(base_url('actions/oauth_start.php?provider=facebook')) ?>" id="authm-oauth-facebook" class="authm-oauth-link flex items-center justify-center gap-2 rounded-xl border border-brand-border py-3 text-sm font-semibold hover:bg-brand-bg-subtle">
